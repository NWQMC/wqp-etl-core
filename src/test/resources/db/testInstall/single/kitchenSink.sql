...
create index if not exists project_data_testsrc_identifier on wqp.project_data_testsrc(project_identifier) with (fillfactor = 100);
...
create index if not exists project_data_testsrc_identifier_old on wqp.project_data_testsrc_old(project_identifier) with (fillfactor = 100);
