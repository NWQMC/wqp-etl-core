...
drop table if exists wqp.country_swap_testsrc cascade;
...
drop table if exists wqp.bio_hab_metric_testsrc cascade;
drop table if exists wqp.char_name_testsrc cascade;
drop table if exists wqp.char_type_testsrc cascade;
drop table if exists wqp.country_testsr cascade;
drop table if exists wqp.county_testsrc cascade;
drop table if exists wqp.ml_grouping_testsrc cascade;
drop table if exists wqp.monitoring_loc_testsrc cascade;
drop table if exists wqp.org_data_testsrc cascade;
drop table if exists wqp.org_grouping_testsrc cascade;
drop table if exists wqp.organization_sum_testsrc cascade;
drop table if exists wqp.organization_testsrc cascade;
