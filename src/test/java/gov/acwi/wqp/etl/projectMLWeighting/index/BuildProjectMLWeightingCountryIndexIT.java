...
public class BuildProjectMLWeightingCountryIndexIT extends BaseBuildProjectMLWeightingIndexesIT {
	...
	public void buildProjectMLWeightingCountryIndexStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils
					.launchStep("buildProjectMLWeightingCountryIndexStep", testJobParameters);
