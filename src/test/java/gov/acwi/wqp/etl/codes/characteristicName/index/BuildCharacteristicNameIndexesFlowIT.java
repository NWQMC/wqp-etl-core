...
public class BuildCharacteristicNameIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = BASE_EXPECTED_DATABASE_QUERY_CHECK_INDEX + "'char_name_swap_stewards'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/characteristicName/indexes/codeValue.xml",
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY + " and indexname='char_name_swap_stewards_code_value'")
