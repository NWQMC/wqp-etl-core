...
public class SetupStateSwapTableFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = "select table_catalog, table_schema, table_name, table_type from information_schema.tables where table_name='state_swap_stewards'";
	...
	@Test
	@ExpectedDatabase(connection="pg", value="classpath:/testResult/wqp/state/drop.xml",
