...
public class BuildCharacteristicTypeIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = "select tablename, indexname, indexdef from pg_indexes where tablename='char_type_swap_stewards'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/characteristicType/indexes/codeValue.xml",
			...
			table=EXPECTED_DATABASE_TABLE, query=EXPECTED_DATABASE_QUERY + " and indexname='char_type_swap_stewards_code_value'")
