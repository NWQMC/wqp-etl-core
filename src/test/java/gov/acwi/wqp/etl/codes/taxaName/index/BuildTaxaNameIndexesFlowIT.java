...
public class BuildTaxaNameIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = BASE_EXPECTED_DATABASE_QUERY_CHECK_INDEX + "'taxa_name_swap_stewards'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/taxaName/indexes/codeValue.xml",
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY + " and indexname='taxa_name_swap_stewards_code_value'")
