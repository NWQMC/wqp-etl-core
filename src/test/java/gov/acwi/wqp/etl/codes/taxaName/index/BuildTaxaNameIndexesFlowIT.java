...
public class BuildTaxaNameIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY_ANALYZE = BASE_EXPECTED_DATABASE_QUERY_CHECK_INDEX + "'taxa_name_swap_testsrc'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/taxaName/indexes/codeValue.xml",
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY_ANALYZE + " and indexname='taxa_name_swap_testsrc_code_value'")
