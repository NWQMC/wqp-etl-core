...
public class BuildOrgGroupingIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY_ANALYZE = BASE_EXPECTED_DATABASE_QUERY_CHECK_INDEX + "'org_grouping_swap_testsrc'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/orgGrouping/indexes/organization.xml",
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY_ANALYZE + " and indexname='org_grouping_swap_testsrc_organization'")
