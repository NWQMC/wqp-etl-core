...
public class BuildOrgGroupingIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = "select tablename, indexname, indexdef from pg_indexes where tablename='org_grouping_swap_stewards'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/orgGrouping/indexes/organization.xml",
			...
			table=EXPECTED_DATABASE_TABLE, query=EXPECTED_DATABASE_QUERY + " and indexname='org_grouping_swap_stewards_organization'")
