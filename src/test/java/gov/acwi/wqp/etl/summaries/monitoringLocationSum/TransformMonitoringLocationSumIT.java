...
public class TransformMonitoringLocationSumIT extends BaseFlowIT {
	...
	@DatabaseSetup(value="classpath:/testData/nwis/country/country.xml")
	@DatabaseSetup(value="classpath:/testData/nwis/state/state.xml")
	@DatabaseSetup(value="classpath:/testData/nwis/county/county.xml")
