...
public class BuildResDetectQntLimitSampleMediaIndexIT extends BaseBuildResDetectQntLimitIndexesIT {
	@Test
	...
	public void buildResDetectQntLimitSampleMediaIndexStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils
					.launchStep("buildResDetectQntLimitSampleMediaIndexStep", testJobParameters);
