...
public class BuildProjectDataIndexesFlowIT extends BaseFlowIT {
	...
	public static final String EXPECTED_DATABASE_QUERY = BASE_EXPECTED_DATABASE_QUERY_CHECK_INDEX + "'project_data_swap_stewards'";
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/projectData/indexes/organization.xml",
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY + " and indexname='project_data_swap_stewards_organization'")
	...
	@ExpectedDatabase(value="classpath:/testResult/wqp/projectData/indexes/identifier.xml",
			assertionMode=DatabaseAssertionMode.NON_STRICT_UNORDERED,
			table=EXPECTED_DATABASE_TABLE_CHECK_INDEX, query=EXPECTED_DATABASE_QUERY + " and indexname='project_data_swap_stewards_identifier'")
