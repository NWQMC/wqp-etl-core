...
public class AfterLoadProjectDataFlowIT extends BaseFlowIT {

	public static final String TABLE_NAME = "'project_data_swap_testsrc'";
	...
	@Before
	public void setUp() {
		testJob = jobBuilderFactory.get("afterLoadProjectDataFlowTest")
				.start(afterLoadProjectDataFlow)
				.build()
				.build();
	...
	@Test
	@ExpectedDatabase(
			value="classpath:/testResult/analyze/projectData.xml",
			assertionMode=DatabaseAssertionMode.NON_STRICT_UNORDERED,
			table=EXPECTED_DATABASE_TABLE_CHECK_ANALYZE,
			query=EXPECTED_DATABASE_QUERY_ANALYZE)
	public void analyzeProjectDataStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils.launchStep("analyzeProjectDataStep", testJobParameters);
	...
	public void addProjectDataPrimaryKeyStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils.launchStep("addProjectDataPrimaryKeyStep", testJobParameters);
			assertEquals(ExitStatus.COMPLETED, jobExecution.getExitStatus());
		} catch (Exception e) {
			e.printStackTrace();
			fail(e.getLocalizedMessage());
	...
	@ExpectedDatabase(
			...
			table=EXPECTED_DATABASE_TABLE_CHECK_ANALYZE,
			query=EXPECTED_DATABASE_QUERY_ANALYZE)
	public void afterLoadProjectDataFlowTest() {
		try {
