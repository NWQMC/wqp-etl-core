...
public class InstallFailureIT extends BaseFlowIT {
	...
	@ExpectedDatabase(connection=CONNECTION_INFORMATION_SCHEMA, value="classpath:/testResult/wqp/installTablesFailure/",
			assertionMode=DatabaseAssertionMode.NON_STRICT_UNORDERED,
			table=EXPECTED_DATABASE_TABLE_CHECK_TABLE, query=EXPECTED_DATABASE_QUERY_TABLE)
	@ExpectedDatabase(value="classpath:/testResult/wqp/installFailure.xml", assertionMode=DatabaseAssertionMode.NON_STRICT_UNORDERED)
