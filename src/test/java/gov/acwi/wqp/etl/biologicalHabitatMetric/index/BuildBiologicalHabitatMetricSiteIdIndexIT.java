...
public class BuildBiologicalHabitatMetricSiteIdIndexIT extends BaseBuildBiologicalHabitatMetricIndexesIT {
	...
	public void buildBiologicalHabitatMetricSiteIdIndexStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils
					.launchStep("buildBiologicalHabitatMetricSiteIdIndexStep", testJobParameters);
