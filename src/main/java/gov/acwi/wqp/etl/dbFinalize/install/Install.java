...
import gov.acwi.wqp.etl.monitoringLocationObject.MonitoringLocationObject;
...
import gov.acwi.wqp.etl.resultObject.ResultObject;
...
public class Install implements Tasklet {
	...
	protected Collection<InstallTable> getInstallTables() {
		...
		installTables.add(new InstallTable(wqpDataSource, wqpSchemaName, ProjectObject.BASE_TABLE_NAME, wqpDataSourceId));
		...
		installTables.add(new InstallTable(wqpDataSource, wqpSchemaName, MonitoringLocationObject.BASE_TABLE_NAME, wqpDataSourceId));
		installTables.add(new InstallTable(wqpDataSource, wqpSchemaName, Activity.BASE_TABLE_NAME, wqpDataSourceId));
		installTables.add(new InstallTable(wqpDataSource, wqpSchemaName, ActivityObject.BASE_TABLE_NAME, wqpDataSourceId));
		...
		installTables.add(new InstallTable(wqpDataSource, wqpSchemaName, ResultObject.BASE_TABLE_NAME, wqpDataSourceId));
