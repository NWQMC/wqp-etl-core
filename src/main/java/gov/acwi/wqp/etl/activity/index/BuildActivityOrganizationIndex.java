...
@Component
@StepScope
public class BuildActivityOrganizationIndex implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		jdbcTemplate.query("select * from build_activity_swap_organization_index(?,?)", pss, new NoopResultSetExtractor());
