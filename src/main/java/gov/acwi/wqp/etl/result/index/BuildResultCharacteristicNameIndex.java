...
@Component
@StepScope
public class BuildResultCharacteristicNameIndex extends BuildCharacteristicNameIndex {

	@Autowired
	public BuildResultCharacteristicNameIndex(JdbcTemplate jdbcTemplate,
