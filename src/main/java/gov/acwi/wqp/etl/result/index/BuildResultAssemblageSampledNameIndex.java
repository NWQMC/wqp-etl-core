...
@Component
@StepScope
public class BuildResultAssemblageSampledNameIndex extends BuildAssemblageSampledNameIndex {

	@Autowired
	public BuildResultAssemblageSampledNameIndex(JdbcTemplate jdbcTemplate,
