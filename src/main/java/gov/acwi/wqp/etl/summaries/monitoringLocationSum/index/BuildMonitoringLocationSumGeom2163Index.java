...
@Component
@StepScope
public class BuildMonitoringLocationSumGeom2163Index extends BuildGeom2163Index {

	@Autowired
	public BuildMonitoringLocationSumGeom2163Index(JdbcTemplate jdbcTemplate,
