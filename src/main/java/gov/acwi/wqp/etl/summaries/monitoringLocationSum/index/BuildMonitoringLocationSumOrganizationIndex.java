...
@Component
@StepScope
public class BuildMonitoringLocationSumOrganizationIndex extends BuildOrganizationIndex {

	@Autowired
	public BuildMonitoringLocationSumOrganizationIndex(JdbcTemplate jdbcTemplate,
