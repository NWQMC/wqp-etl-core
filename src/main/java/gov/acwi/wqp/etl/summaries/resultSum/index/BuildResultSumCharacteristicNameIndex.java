...
@Component
@StepScope
public class BuildResultSumCharacteristicNameIndex extends BuildCharacteristicNameIndex {

	@Autowired
	public BuildResultSumCharacteristicNameIndex(JdbcTemplate jdbcTemplate,
