...
@Component
@StepScope
public class BuildProjectMLWeightingOrganizationIndex extends BuildOrganizationIndex {

	@Autowired
	public BuildProjectMLWeightingOrganizationIndex(JdbcTemplate jdbcTemplate,
