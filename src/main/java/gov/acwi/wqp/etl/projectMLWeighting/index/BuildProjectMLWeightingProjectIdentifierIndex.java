...
@Component
@StepScope
public class BuildProjectMLWeightingProjectIdentifierIndex extends BuildProjectIdentifierIndex {

	@Autowired
	public BuildProjectMLWeightingProjectIdentifierIndex(JdbcTemplate jdbcTemplate,
