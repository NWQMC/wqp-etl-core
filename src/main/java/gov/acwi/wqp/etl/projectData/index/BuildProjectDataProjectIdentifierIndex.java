...
@Component
@StepScope
public class BuildProjectDataProjectIdentifierIndex extends BuildProjectIdentifierIndex {

	@Autowired
	public BuildProjectDataProjectIdentifierIndex(JdbcTemplate jdbcTemplate,
