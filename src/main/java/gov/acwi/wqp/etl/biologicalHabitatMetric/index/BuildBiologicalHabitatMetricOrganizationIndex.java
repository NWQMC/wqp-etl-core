...
@Component
@StepScope
public class BuildBiologicalHabitatMetricOrganizationIndex extends BuildOrganizationIndex {

	@Autowired
	public BuildBiologicalHabitatMetricOrganizationIndex(JdbcTemplate jdbcTemplate,
