...
@Component
@StepScope
public class BuildBiologicalHabitatMetricGeom2163Index extends BuildGeom2163Index {

	@Autowired
	public BuildBiologicalHabitatMetricGeom2163Index(JdbcTemplate jdbcTemplate,
