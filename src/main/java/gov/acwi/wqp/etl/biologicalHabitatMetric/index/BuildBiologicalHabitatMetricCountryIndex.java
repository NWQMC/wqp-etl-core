...
@Component
@StepScope
public class BuildBiologicalHabitatMetricCountryIndex extends BuildCountryIndex {

	@Autowired
	public BuildBiologicalHabitatMetricCountryIndex(JdbcTemplate jdbcTemplate,
