create or replace function build_activity_swap_organization_index(wqp_data_source character varying, schema_name character varying)
returns void
language plpgsql
as $$
declare
	base_table_name varchar := 'activity';
