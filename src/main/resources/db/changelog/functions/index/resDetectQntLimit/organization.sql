create or replace function build_r_detect_qnt_lmt_swap_organization_index(wqp_data_source character varying, schema_name character varying)
returns void
language plpgsql
as $$
declare
	base_table_name varchar := 'r_detect_qnt_lmt';
