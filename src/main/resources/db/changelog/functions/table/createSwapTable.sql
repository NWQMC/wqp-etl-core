...
begin
	execute format('create unlogged table if not exists %I.%I (like %I.%I including comments including defaults including identity) with (fillfactor = 100)', wqp_schema_name, swap_table_name, wqp_schema_name, base_table_name);
end
$$